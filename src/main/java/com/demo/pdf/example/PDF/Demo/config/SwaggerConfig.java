package com.demo.pdf.example.PDF.Demo.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder().title("Practicando Swagger Computadora FACTURA- COMPRA CON PDF")
                .description("Este proyecto es solo una prueba de (SPRING) el cual " +
                        "poco a poco implementaremos e integraremos mas cosas" +
                        "repositorio: https://github.com/KevinSuasnabar/sistema_factruracion.git").build();
    }
